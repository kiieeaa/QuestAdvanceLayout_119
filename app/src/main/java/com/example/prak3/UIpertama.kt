        ...
        Card(
            ...
            )
            {
                ...
                Column {
                    ...
                    Text(
                        stringResource(R.string.alamat2), // Teks hardcode
                        fontSize = 18.sp, // Sesuaikan ukuran font
                        color = Color.Yellow, // Ganti warna jika perlu
                        modifier = Modifier.padding(top = 10.dp)
                    )
        ...
        Card(
            ...
            Row(
                ...
                Column {
                    // Teks sesuai gambar (3 baris)
                    Text(
                        stringResource(R.string.nama3), // Teks hardcode
                        fontSize = 30.sp,
                        fontFamily = FontFamily.Cursive,
                        color = Color.White,
                        modifier = Modifier.padding(top = 15.dp)
                    ...
                    Text(
                        stringResource(R.string.nim3), // Teks hardcode
                        fontSize = 18.sp, // Sesuaikan ukuran font
                        color = Color.Yellow, // Ganti warna jika perlu
                        modifier = Modifier.padding(top = 10.dp)
                    )
                    Text(
                        stringResource(R.string.alamat3), // Teks hardcode
                        fontSize = 18.sp, // Sesuaikan ukuran font
                        color = Color.Yellow, // Ganti warna jika perlu
                        modifier = Modifier.padding(top = 10.dp)
                    )
